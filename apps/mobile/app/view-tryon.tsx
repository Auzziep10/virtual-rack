    ...
    <View style={styles.container} {...panResponder.panHandlers}>
        ...
        renderItem={({ item }) => (
          <View style={{ width, height: '100%' }}>
            ...
            <View style={[styles.bottomControls, { paddingBottom: insets.bottom + 20 }]}>
              ...
              >
                <BlurView intensity={100} tint="systemThinMaterialLight" style={styles.circleBlur}>
              ...
              >
                <BlurView intensity={100} tint="systemThinMaterialLight" style={styles.pillBlur}>
      ...
      <View style={[styles.topBar, { top: insets.top + 10 }]}>
        <TouchableOpacity 
          ...
          onPress={() => router.back()}
        >
          <BlurView intensity={100} tint="systemThinMaterialLight" style={styles.closeBlur}>
